...
Custom Code nak hívnak. Ezt a menüpontot a **WordPress Admin - Elementor - Custom Code** menüpontban találod meg. Az előkészület első lépése, hogy a Custom Code  menüpontban
...
Ide később visszatérünk, mivel maga a kódot ide kell bemásolnunk. Mindenképpen hagyd nyitva, hogy könnyedén áttudj ide naivigálni, hogy bemásold a kódot.
...
<BrowserWindow url="https://peldaweboldal.hu">
  <img src="/img/urlapkep1.png" alt="Elementor Űrlap"></img>
</BrowserWindow>
...
jQuery(document).ready(function($) {
  ...
  $('input[id^="form-field-mycheckboxfield-"]').click(function() {
    ...
    if (checkedCount < maxChecked) {
      ...
      $('label[for^="form-field-mycheckboxfield-"]:last').after(warningText); /* itt tudod módosítani milyen figyelmztető szöveg jelenjen meg */
