...
A **CHILD ITEM ID** mezőbe pedig az **inserted_cct_id** kell kiválasztanod. Az utolsó **UPDATE CONTEXT**-nél pedig a **We updating children items for the parent object** kell választanod.
<BrowserWindow url="https://peldaweboldal.hu">
