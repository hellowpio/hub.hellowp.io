...
A GitHub Copilot öt szinten érhető el:

### Egyéni csomagok

| Csomag | Ár | Funkciók |
|--------|-----|----------|
| **Free** | $0 | 2000 completion + 50 chat/hó |
| **Pro** | $10/hó | Unlimited + 300 premium request |
| **Pro+** | $39/hó | 1500 premium request + összes modell |

### Üzleti csomagok

| Csomag | Ár | Funkciók |
|--------|-----|----------|
| **Business** | $19/felhasználó/hó | IP indemnity, audit log |
| **Enterprise** | $39/felhasználó/hó | 1000 premium request, custom models |
...
A premium request-ek fejlettebb modelleket használnak:
- **Claude 3.7 Sonnet**
- **Gemini 2.5 Pro**
- **OpenAI o1, o3**
- **Claude Opus 4** (csak Pro+)

Limit túllépés esetén: **$0.04/request**
