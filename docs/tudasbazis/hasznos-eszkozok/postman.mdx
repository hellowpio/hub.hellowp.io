...
A Postman beépített támogatást kapott a **Model Context Protocol (MCP)** számára, amely lehetővé teszi AI ágensek számára készült API-k tervezését és tesztelését.

### AI funkciók

- AI-alapú kódgenerálás
- Intelligens request javaslatok
- Automatikus dokumentáció készítés
