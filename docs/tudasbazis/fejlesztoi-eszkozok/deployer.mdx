---
title: Deployer
description: Automatizált WordPress deployment Deployer PHP segítségével.
keywords:
  - deployer
  - deployment
  - automatizálás
...
# <FontAwesomeIcon icon="fa-duotone fa-rocket-launch text-primary" /> Deployer - PHP Deployment Eszköz

A [Deployer](https://deployer.org/) egy PHP alapú deployment automatizálási eszköz. Zero-downtime deployment-et biztosít, támogatja a rollback-et, és speciális WordPress receptekkel rendelkezik.
...
- [Deployer dokumentáció](https://deployer.org/docs/7.x/getting-started)
